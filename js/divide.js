...
function Division(){
    var d_num1 = Math.floor(Math.random() * 20);
    var d_num2 = Math.floor(Math.random() * 10);
    var d_dummyAnswer1 = Math.floor(Math.random() * 20);
    var d_dummyAnswer2 = Math.floor(Math.random() * 10);
    var d_allAnswer = [];
    var d_switchAnswer = [];

    d_answer = d_num1 / d_num2;
...
d_option1.addEventListener("click", function (){
    if (d_option1.innerHTML == d_answer){
        Division();
    }else {
        audio.play();
    }
...
d_option2.addEventListener("click", function (){
    if (d_option2.innerHTML == d_answer){
        Division();
    }else {
        audio.play();
    }
...
d_option3.addEventListener("click", function (){
    if (d_option3.innerHTML == d_answer){
        Division();
    }else {
        audio.play();
    }
